...
def se_simplenet18(pretrained=False, progress=True, **kwargs):
    return _simplenet('se_simplenet18', SEBasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def se_simplenet34(pretrained=False, progress=True, **kwargs):
    return _simplenet('se_simplenet34', SEBasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def se_simplenet50(pretrained=False, progress=True, **kwargs):
    return _simplenet('se_simplenet50', SEBottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
