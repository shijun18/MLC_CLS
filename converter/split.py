...
input_dir = '/staff/shijun/torch_projects/MLC_CLS/dataset/raw_data_v2/dose'
save_dir = '/staff/shijun/torch_projects/MLC_CLS/dataset/raw_data_v2'
...
for subdir in os.scandir(input_dir):
    train_subdir = os.path.join(train_dir,f'{subdir.name}/{os.path.basename(input_dir)}')
    test_subdir = os.path.join(test_dir,f'{subdir.name}/{os.path.basename(input_dir)}')
